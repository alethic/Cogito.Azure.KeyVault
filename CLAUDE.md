...
Cogito.Azure.KeyVault — Additional components for managing Azure Key Vaults.

Publishes 3 packages: `Cogito.Azure.KeyVault`, `Cogito.Azure.KeyVault.Autofac`, `Cogito.Azure.KeyVault.DataProtection`.
